...
public class UserResumeDownloadServlet extends AutoinjectingRemoteServiceServlet {
    ...
    private void downloadFile(HttpServletRequest req, HttpServletResponse response) throws IOException, ServiceException {
        ...
        pdfService.createActiveInterviewDevResumePDF(userId, response.getOutputStream());
