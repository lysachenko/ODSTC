package com.netcracker.tc.shared.model.filter;

import java.io.Serializable;
import java.util.Date;

public class MailFilterDTO implements Serializable {
    ...
    public MailFilterDTO(Date addedDate, Boolean isSent, String receiverAddress, String receiverSubject, String receiverBody) {
